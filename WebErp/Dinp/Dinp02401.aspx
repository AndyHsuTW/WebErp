<%@ Page Language="C#" MasterPageFile="~/master/BaseMasterPage.master" AutoEventWireup="true" CodeFile="Dinp02401.aspx.cs" Inherits="Dinp_Dinp02301" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Dinp02301Search" v-if="Display" v-cloak>
        <ul class="app-title">
            <li>{{"Dinp02401 出貨資料查詢 <%=this.AppVersion %>"}}
            </li>
        </ul>
        <div class="app-body">
